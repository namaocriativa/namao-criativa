...
export const SplitVideoHeroPropsSchema = HeroPropsSchema.extend({
  video: z.string().optional(),
  portraitVideo: z.string().optional(),
  portraitImage: z.string().optional(),
  portraitCaption: optionalString,
  portraitSubcaption: optionalString,
  overlayOpacity: z.number().min(0).max(1).optional().default(0.58),
  highlights: z
    .array(
      z.object({
        label: z.string().min(1),
...
export const PROP_SCHEMAS = {
  ...
  'navbar.overlay': NavbarPropsSchema,
  ...
  'hero.split-video': SplitVideoHeroPropsSchema,
...
export type SplitVideoHeroProps = z.infer<typeof SplitVideoHeroPropsSchema>;
