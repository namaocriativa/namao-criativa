...
export const COLOR_INTENSITY_IDS = ['leve', 'moderado', 'high'] as const;
export type ColorIntensity = (typeof COLOR_INTENSITY_IDS)[number];
...
export const COMPONENT_ALIASES: Record<string, ComponentId> = {
  ...
  marketingHero: 'hero.marketing',
  marketingNav: 'navbar.marketing',
  overlayNav: 'navbar.overlay',
  splitVideoHero: 'hero.split-video',
  templateCarousel: 'gallery.carousel',
  showcaseFeatures: 'features.showcase',
  statsProof: 'social-proof.stats',
  darkCta: 'cta.dark',
