...
const PREMIUM: Partial<Record<ComponentId, CapabilityMeta>> = {
  ...
  'hero.split-video': {
    capabilities: ['animation', 'video', 'image', 'scroll'],
    runtime: 'premium',
    performance: 'dois vídeos só quando visíveis; fallback imagem',
    mobile: 'retrato abaixo do copy; sem autoplay se reduced motion',
  },
  'layout.section': {
    capabilities: ['layout'],
    runtime: 'premium',
