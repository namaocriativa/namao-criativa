import { MAP_FEATURE_ID } from './map/resolve';
...
export type { MapLocationBrief, MapSectionRef } from './map/resolve';
...
export const FEATURE_CATALOG: FeatureMetadata[] = [
  ...
  },
  {
    ...
    llmContract:
      'Google Maps embed inside the wizard-chosen section. Do not create a map section and do not invent this id — the user already selected it.',
  },
  {
